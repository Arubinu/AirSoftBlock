/* $Id: Buzzer.cpp 119 2010-07-17 18:56:36Z bhagman@roguerobotics.com $

  A Buzzer Generator Library
...
#define AVAILABLE_BUZZER_PINS 6

// Leave timers 1, and zero to last.
const uint8_t PROGMEM buzzer_pin_to_timer_PGM[] = { 2, 3, 4, 5, 1, 0 };

#elif defined(__AVR_ATmega8__)

#define AVAILABLE_BUZZER_PINS 2

const uint8_t PROGMEM buzzer_pin_to_timer_PGM[] = { 2, 1 };

#else

#define AVAILABLE_BUZZER_PINS 3

// Leave timer 0 to last.
const uint8_t PROGMEM buzzer_pin_to_timer_PGM[] = { 2, 1, 0 };
...
uint8_t Buzzer::_buzzer_pin_count = 0;


void Buzzer::begin(uint8_t buzzerPin)
{
  if (_buzzer_pin_count < AVAILABLE_BUZZER_PINS)
  {
    _pin = buzzerPin;
    _timer = pgm_read_byte(buzzer_pin_to_timer_PGM + _buzzer_pin_count);
    _buzzer_pin_count++;
